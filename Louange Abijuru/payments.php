...
<section>
    ...
    <form method="post">
        ...
        <input type="number" id="mtd" name="mtd" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO payments(paymentid, transactionid, date, amount, method) VALUES (?, ?, ?, ?, ?,)");
    $stmt->bind_param("sssss", $pid, $tid, $dt, $amt, $mtd);
